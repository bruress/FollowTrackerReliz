...
const SignIn = ({setUser}) => {
    ...
    const validationSchema = Yup.object({
        email: Yup.string()                                                     // название формы -> данные из формы это строка?
            .required("Укажите адрес электронной почты")                        // проверка на пустоту
            .email("Проверьте адрес электронной почты")                         // проверка - email?
        ...
        password: Yup.string()
            ...
            .min(6, "Пароль может состоять минимум из 6 символов")              // проверяет длину строки с минимум                              
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post("/api/auth/login", form);     // запрос на бек
            setMessage("Авторизация прошла успешно");                       // сообщение об успешной авторизации
            setForm({                                                       // очищаем формочки
                email: "",
                password: ""
            });
    ...
    return (
        ...
        <div className="overscroll-contain flex flex-col items-center mx-[20px] sm:mx-[150px] 2xl:mx-[300px] pt-[50px]">
            ...
            <Text
                text="Авторизация"
                type="title_dr"
                classes="text-center 2xl:px-[200px] pb-[30px] pt-[150px]"
            />
